return {
    ...
    opts = {
        ...
        on_attach = function(bufnr)
            ...
            -- Actions
            -- map("n", "<leader>gs", gs.stage_hunk, "git add 块")
            -- map("n", "<leader>gr", gs.reset_hunk, "git reset 块")
            ...
            -- map("n", "<leader>gS", gs.stage_buffer, "git add 文件") -- stage whole buffer
            -- map("n", "<leader>gR", gs.reset_buffer, "git reset 文件") -- unstage whole buffer
